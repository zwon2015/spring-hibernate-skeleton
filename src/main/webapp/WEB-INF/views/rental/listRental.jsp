...
<body>
		...
		<table width="100%" border="1">
			...
			<c:forEach items="${rental}" var="rental">
				<tr>
					...
					<td><fmt:formatDate value="${rental.startDate}"
							pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${rental.endDate}"
							pattern="yyyy-MM-dd" /></td>
					<td><fmt:formatDate value="${rental.maxDuration}"
							pattern="yyyy-MM-dd" /></td>
	...
	<div style="text-align: center;">
		<a href="rental/add">Add Rental</a>
	</div>
